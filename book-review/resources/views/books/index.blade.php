@extends('layout.app')
@section('content')
<h1 class="mb-4 text 2x1">Books</h1>

<form method="GET" action="{{ route('books.index') }}" class="mb-4 flex items-center space-x-4">
<input type="text" name="title" placeholder="search for a title" value="{{request('title')}}" class="input" />
...
<div class="filter-container mb-4 flex">
 ...
 $filters = [
    ...
    'popular_last_6month' => 'popular_ last 6 months',
